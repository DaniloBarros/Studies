...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    ViewController *view = [[ViewController alloc] initWithNibName:@"ViewController1" bundle:nil];
    ViewController2 *view2 = [[ViewController2 alloc] initWithNibName:@"ViewController2" bundle:nil];
    
    self.bar = [[UITabBarController alloc] init];
    
    self.bar.viewControllers = @[view, view2];
